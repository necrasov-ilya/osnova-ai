...
На продуктовой стадии Gemma4-E2B не блокирует разработку. Архитектура должна позволять заменить on-device VLM на серверный fallback или мок, пока UI, очередь и Smart Insert набирают форму.
